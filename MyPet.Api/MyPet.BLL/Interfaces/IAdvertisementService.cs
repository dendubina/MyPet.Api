...
namespace MyPet.BLL.Interfaces
{
    ...
    {
        Task<AdvertisementDTO> AddAdvertisementAsync(AddAdvertisementModel model, string userId);        
        ...
        Task<AdvertisementDTO> UpdateAdvetrtisementAsync(UpdateAdvertisementModel model, string userId);
