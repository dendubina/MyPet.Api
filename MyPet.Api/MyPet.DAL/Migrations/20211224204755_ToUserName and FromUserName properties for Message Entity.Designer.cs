...
namespace MyPet.DAL.Migrations
{
    ...
    [Migration("20211224204755_ToUserName and FromUserName properties for Message Entity")]
    partial class ToUserNameandFromUserNamepropertiesforMessageEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyPet.DAL.Entities.Chat.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyPet.DAL.Entities.Chat.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyPet.DAL.Entities.Chat.Message", b =>
                {
                    b.HasOne("MyPet.DAL.Entities.Chat.Chat", "Chat")
                        .WithMany("Messages")
